...
```{r}
## define directories here and comment out the sourcing 
source(timing_paths.R)
# timing_dir_staar = ...
# timing_dir_monti = ...
# timing_dir_seed_genes = ...
# complete_seed_gene_experiment_dir = ...
# deeprvat_train_time_res = ...
# deeprvat_timing_dir = ...
...
saveRDS(this_df_x_fold,'timing_data_x_fold_60_pheno.Rds') #to use for plotting of the main figure
```
...
```{r}
ggarrange(p_training_time, p_timing, nrow = 1, align = 'h',
