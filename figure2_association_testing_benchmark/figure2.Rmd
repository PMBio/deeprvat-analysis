...
monti_quant_dir = ''  #directory where Monti has been run on unrelated Caucasian individuals from the 200k WES cohort
staar_quant_dir = '' #directory where STAAR has been run on unrelated Caucasian individuals from the 200k WES cohort
deeprvat_dir = "" #directory where DeepRVAT has been run on unrelated Caucasian individuals from the 200k WES cohort

deeprvat_dir_syn = '' #directory where the DeepRVAT model from deeprvat_dir has been applied for association testing on synonymous variants only (unrelated Caucasian individuals from the 200k WES cohort) 

timing_data_dir = '' #directory where the timing experiments have been run 
