...
```{r}
standard_deeprvat_exp_name = 'deeprvat_cv_bf_seed_genes'
results_dir_standard_deeprvat <- file.path("/path", standard_deeprvat_exp_name)
...
```{r}
downsampledsg_experiment_dir = file.path("/path", "deeprvat_cv_seed_gene_sensitivity")
num_exps <- 5
