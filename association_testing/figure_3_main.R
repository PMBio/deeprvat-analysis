...
if(checkResExistence(quant_phenotypes, results_dir, results_dir_pattern)){
  ...
  print('taking statin corrected folders all phenotypes')
  pheno_choice = 'all_phenotypes'
  ...
  print('taking statin corrected folders training_phenotypes')
  pheno_choice = 'training_phenotypes'
  ...
  print('taking statin corrected folders new_phenotypes')
  pheno_choice = 'new_phenotypes'
